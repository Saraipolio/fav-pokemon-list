...
struct PokemonWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = PokemonWidgetAttributes(name: "Me")
    static let contentState = PokemonWidgetAttributes.ContentState(value: 3)
